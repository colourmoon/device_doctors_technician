...
class MultiSelectDropdownSelect extends StatefulWidget {
  ...
  const MultiSelectDropdownSelect({
    super.key,
    required this.list,
  ...
  const MultiSelectDropdownSelect.simpleList({
    super.key,
    required this.list,
    this.suffixIconWidget,
    required this.initiallySelected,
  ...
  @override
  State<MultiSelectDropdownSelect> createState() => _MultiSelectDropdownState();
}

class _MultiSelectDropdownState extends State<MultiSelectDropdownSelect> {
